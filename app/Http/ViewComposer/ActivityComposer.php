...
class	ActivityComposer{
	...
	public	function	compose(View $view)
	{
		...
		$mostWriters = Cache::remember('mostWriters', now()->addMinutes(10), function ()
		{
			return (User::mostWriter()->take(5)->get());
		});

		$usersActiveLastMounth = Cache::remember('usersActiveLastMounth', now()->addMinutes(10), function ()
		{
